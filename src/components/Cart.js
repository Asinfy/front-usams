...
export const Cart = ({discountPurchase, setDiscountPurchase, setTotalDiscount, totalDiscount, productsCart, setProductsCart, iva, setIva, subtotal, setSubtotal, total, setTotal, isAuth, user, setUser}) => {
    ...
    const getListCart = () => {
        let products_cart = JSON.parse(localStorage.getItem("product_usams_asc"));
    ...
    const deleteProductCart = (id) => {
        ...
        localStorage.setItem('product_usams_asc', JSON.stringify(new_products_cart));
    ...
    useEffect( () => {
        ...
        let products_cart = localStorage.getItem('product_usams_asc') ? JSON.parse(localStorage.getItem('product_usams_asc')) : [];
